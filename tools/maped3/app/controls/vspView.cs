...
namespace winmaped2
{
	...
	public class vspView: Control
	{
		...
		/* public properties                              */
		/**************************************************/
		public int SelectedTileF { get { return st0; } set { if(value<0)return; st0 = value; Invalidate(); if(viewer_a == null) return; viewer_a.ActiveTile = (Vsp24Tile)parent_vsp.Tiles[st0]; if(SelectionChanged!=null) SelectionChanged(); } }
		public int SelectedTileB { get { return st1; } set { if(value<0)return; st1 = value; Invalidate(); if(viewer_b == null) return; viewer_b.ActiveTile = (Vsp24Tile)parent_vsp.Tiles[st1]; if(SelectionChanged!=null) SelectionChanged(); } }
		public VSPController.ControllerMode ControllerMode { get { return controller_mode; } set { controller_mode = value; } }
		public VSPController.ControllerType ControllerType { get { return controller_type; } set { controller_type = value; } }
		protected override Size DefaultSize { get { return new Size(320,160); } }
		public TileViewer PrimaryTileViewer { get { return viewer_a; } set { viewer_a = value; } }
		public TileViewer SecondaryTileViewer { get { return viewer_b; } set { viewer_b = value; } }
		public Vsp24 ActiveVsp { get { return parent_vsp; } set { parent_vsp = value; } }
		...
		private void activateMouse(MouseEventArgs e)
		{
			...
			if ( e.Button == MouseButtons.Left || e.Button == MouseButtons.Right )
			{
				...
				{
					int tile = ((scrollOffset/16)+(my/16)) * TilesWide + (mx/16);
					if(tile>=parent_vsp.ObstructionTiles.Count) return;
					if(e.Button==MouseButtons.Left) 
					{
						st0=tile;
						if(viewer_a!=null)

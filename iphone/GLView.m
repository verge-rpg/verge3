...
- (void)displayLayer:(CALayer *)theLayer
{
	...
	CGImageRef bitmap = CGImageCreate(320,480,5,16,320*2,colorSpace, kCGImageAlphaNoneSkipFirst | kCGBitmapByteOrder16Little, bitmapProvider, NULL, FALSE, kCGRenderingIntentDefault); 
